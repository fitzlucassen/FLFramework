...
<div id="ErrorPage">
	...
	<ul>
	<li>Vérifier que la fonction <b><?php echo $this->Model->_modelTarget; ?></b> du contrôleur <b><?php echo $this->Model->_controllerTarget; ?></b>, se termine bien par : <i>'$this->_view->ViewCompact($this->_controller, $this->_action, array("Model" => $this->Model)'</i></li>
